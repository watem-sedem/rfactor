...
def valid_freq(freq,mode_test_freq):
    ...
    Parameters
    ----------
    freq: pandas.DatetimeIndex.freq
        Frequency
    mode_test_freq: int
        1: Frequency of input rainfall data must be at least minute resolution.
        2: Frequency of input rainfall data must be 10-minute resolution.
    """
    # test for frequency
    if freq is None:
